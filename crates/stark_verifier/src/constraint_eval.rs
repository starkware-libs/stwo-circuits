...
pub fn compute_composition_polynomial<Value: IValue>(
    ...
    .enumerate()
    {
        ...
        let trace_columns = get_n_columns(&mut oods_samples.trace, component_info.trace_columns);
        let interaction_columns =
            get_n_columns(&mut oods_samples.interaction, component_info.interaction_columns);
