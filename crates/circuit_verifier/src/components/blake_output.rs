...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let numerator_9 = eval!(context, -(blake_output0_mults));
    ...
    let numerator_10 = eval!(context, -(blake_output1_mults));
...
impl<Value: IValue> CircuitEval<Value> for Component {
    ...
    fn log_size(
        ...
        preprocessed_column_log_sizes
            .get(&PreProcessedColumnId { id: "final_state_addr".to_string() })
            .cloned()
    }
}
#[cfg(test)]
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([
            ...
            (
                ...
                context.constant(qm31_from_u32s(887099387, 492597255, 1065933015, 342073962)),
            ),
            (
            ...
            (
                ...
                context.constant(qm31_from_u32s(1768943895, 692885502, 53437623, 1816514837)),
            ),
        ]);
