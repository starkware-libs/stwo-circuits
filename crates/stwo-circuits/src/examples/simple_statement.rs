...
use crate::stark_verifier::statement::{AtOods, Statement};
...
impl Statement for SimpleStatement {
    fn evaluate(
        ...
        let [const_val] = at_oods.preprocessed_columns[..].try_into().unwrap();
        let [a, b, c, d] = at_oods.trace[..].try_into().unwrap();
        ...
        let prev_logup_sum = from_partial_evals(
            context,
            [
                at_oods.interaction.at_prev(0),
                at_oods.interaction.at_prev(1),
                at_oods.interaction.at_prev(2),
                at_oods.interaction.at_prev(3),
            ],
        );
        let cur_logup_sum = from_partial_evals(
            context,
            [
                at_oods.interaction.at_oods(0),
                at_oods.interaction.at_oods(1),
                at_oods.interaction.at_oods(2),
                at_oods.interaction.at_oods(3),
            ],
        );
