...
fn test_generate_empty_preprocessed_trace() {
    ...
    let preprocessed_trace = generate_preprocessed_trace::<SimdBackend>(&circuit);
...
fn test_generate_preprocessed_trace() {
    ...
    assert_eq!(preprocessed_trace.len(), 6);
    assert_eq!(preprocessed_trace[0].length, 8);
    assert_eq!(preprocessed_trace[1].length, 8);
    assert_eq!(preprocessed_trace[2].length, 8);
    assert_eq!(preprocessed_trace[3].length, 8);
    assert_eq!(preprocessed_trace[4].length, 2);
    assert_eq!(preprocessed_trace[5].length, 2);
    expect![[r#"
