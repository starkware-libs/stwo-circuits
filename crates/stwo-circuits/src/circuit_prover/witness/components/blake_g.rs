...
fn write_trace_simd(
    ...
    let M31_2 =  PackedM31::broadcast(M31::from(2)); // Leo: Subsitutes the above.
    ...
    let M31_5 = PackedM31::broadcast(M31::from(5)); // Leo: Subsitutes the above.
    ...
    (
        ...
        .into_par_iter()
        .enumerate()
        .for_each(|(row_index, (row, lookup_data, sub_component_inputs, blake_g_input))| {
            ...
            *row[13] = triple_sum32_res_limb_1_col13;
            ...
            let ms_8_bits_tmp_f72c8_4 = ((triple_sum_32_output_tmp_f72c8_3.low()) >> (UInt16_8));
            ...
            *row[14] = ms_8_bits_col14;
            ...
            let ms_8_bits_tmp_f72c8_6 = ((triple_sum_32_output_tmp_f72c8_3.high()) >> (UInt16_8));
            ...
            *row[16] = ms_8_bits_col16;
            let split_16_low_part_size_8_output_tmp_f72c8_9 =
                [((input_limb_6_col6) - ((ms_8_bits_col16) * (M31_256))), ms_8_bits_col16];
            ...
            *row[17] = ms_8_bits_col17;
            let split_16_low_part_size_8_output_tmp_f72c8_11 =
                [((input_limb_7_col7) - ((ms_8_bits_col17) * (M31_256))), ms_8_bits_col17];
            ...
            *lookup_data.verify_bitwise_xor_8_1 =
            ...
            let xor_tmp_f72c8_16 =
                ((PackedUInt16::from_m31(split_16_low_part_size_8_output_tmp_f72c8_7[0]))
                    ^ (PackedUInt16::from_m31(split_16_low_part_size_8_output_tmp_f72c8_11[0])));
            ...
            *lookup_data.verify_bitwise_xor_8_b_1 =
                [M31_4, ms_8_bits_col15, ms_8_bits_col17, xor_col21];
            ...
            *row[24] = ms_4_bits_col24;
            let split_16_low_part_size_12_output_tmp_f72c8_27 =
                [((input_limb_2_col2) - ((ms_4_bits_col24) * (M31_4096))), ms_4_bits_col24];
            ...
            *row[25] = ms_4_bits_col25;
            let split_16_low_part_size_12_output_tmp_f72c8_29 =
                [((input_limb_3_col3) - ((ms_4_bits_col25) * (M31_4096))), ms_4_bits_col25];

            // Split 16 Low Part Size 12.

            let ms_4_bits_tmp_f72c8_30 = ((triple_sum_32_output_tmp_f72c8_25.low()) >> (UInt16_12));
            ...
            *row[27] = ms_4_bits_col27;
            ...
            let xor_tmp_f72c8_34 =
                ((PackedUInt16::from_m31(split_16_low_part_size_12_output_tmp_f72c8_27[0]))
                    ^ (PackedUInt16::from_m31(split_16_low_part_size_12_output_tmp_f72c8_31[0])));
            ...
            *lookup_data.verify_bitwise_xor_4_0 =
                [M31_2, ms_4_bits_col24, ms_4_bits_col26, xor_col29];

            // Bitwise Xor Num Bits 12.

            let xor_tmp_f72c8_38 =
                ((PackedUInt16::from_m31(split_16_low_part_size_12_output_tmp_f72c8_29[0]))
                    ^ (PackedUInt16::from_m31(split_16_low_part_size_12_output_tmp_f72c8_33[0])));
            ...
            *lookup_data.verify_bitwise_xor_4_1 =
                [M31_2, ms_4_bits_col25, ms_4_bits_col27, xor_col31];
            ...
            *row[33] = triple_sum32_res_limb_1_col33;
            ...
            let ms_8_bits_tmp_f72c8_48 = ((triple_sum_32_output_tmp_f72c8_47.low()) >> (UInt16_8));
            ...
            *row[34] = ms_8_bits_col34;
            ...
            let ms_8_bits_tmp_f72c8_50 = ((triple_sum_32_output_tmp_f72c8_47.high()) >> (UInt16_8));
            ...
            *row[36] = ms_8_bits_col36;
            let split_16_low_part_size_8_output_tmp_f72c8_53 = [
                ((xor_rot_16_output_tmp_f72c8_20.low().as_m31()) - ((ms_8_bits_col36) * (M31_256))),
                ms_8_bits_col36,
            ];
            ...
            *row[37] = ms_8_bits_col37;
            ...
            let xor_tmp_f72c8_56 =
                ((PackedUInt16::from_m31(split_16_low_part_size_8_output_tmp_f72c8_49[0]))
                    ^ (PackedUInt16::from_m31(split_16_low_part_size_8_output_tmp_f72c8_53[0])));
            ...
            *lookup_data.verify_bitwise_xor_8_3 =
            ...
            let xor_tmp_f72c8_60 =
                ((PackedUInt16::from_m31(split_16_low_part_size_8_output_tmp_f72c8_51[0]))
                    ^ (PackedUInt16::from_m31(split_16_low_part_size_8_output_tmp_f72c8_55[0])));
            ...
            *lookup_data.verify_bitwise_xor_8_b_3 =
                [M31_4, ms_8_bits_col35, ms_8_bits_col37, xor_col41];
            ...
            *row[44] = ms_9_bits_col44;
            let split_16_low_part_size_7_output_tmp_f72c8_71 = [
                ((xor_rot_12_output_tmp_f72c8_42.low().as_m31()) - ((ms_9_bits_col44) * (M31_128))),
                ms_9_bits_col44,
            ];
            ...
            *row[45] = ms_9_bits_col45;
            ...
            let ms_9_bits_tmp_f72c8_74 = ((triple_sum_32_output_tmp_f72c8_69.low()) >> (UInt16_7));
            ...
            *row[46] = ms_9_bits_col46;
            ...
            let ms_9_bits_tmp_f72c8_76 = ((triple_sum_32_output_tmp_f72c8_69.high()) >> (UInt16_7));
            ...
            *row[47] = ms_9_bits_col47;
            ...
            let xor_tmp_f72c8_78 =
                ((PackedUInt16::from_m31(split_16_low_part_size_7_output_tmp_f72c8_71[0]))
                    ^ (PackedUInt16::from_m31(split_16_low_part_size_7_output_tmp_f72c8_75[0])));
            ...
            *lookup_data.verify_bitwise_xor_9_0 =
                [M31_5, ms_9_bits_col44, ms_9_bits_col46, xor_col49];

            // Bitwise Xor Num Bits 7.

            let xor_tmp_f72c8_82 =
                ((PackedUInt16::from_m31(split_16_low_part_size_7_output_tmp_f72c8_73[0]))
                    ^ (PackedUInt16::from_m31(split_16_low_part_size_7_output_tmp_f72c8_77[0])));
            ...
            *lookup_data.verify_bitwise_xor_9_1 =
                [M31_5, ms_9_bits_col45, ms_9_bits_col47, xor_col51];
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor8_0", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor8_1", values1, &[PackedM31::one()]);
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor8b_0", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor8b_1", values1, &[PackedM31::one()]);
                let denom0: PackedQM31 = common_lookup_elements.combine(values0);
                let denom1: PackedQM31 = common_lookup_elements.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor12_0", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor4_0", values1, &[PackedM31::one()]);
                let denom0: PackedQM31 = common_lookup_elements.combine(values0);
                let denom1: PackedQM31 = common_lookup_elements.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor12_1", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor4_1", values1, &[PackedM31::one()]);
                let denom0: PackedQM31 = common_lookup_elements.combine(values0);
                let denom1: PackedQM31 = common_lookup_elements.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor8_2", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor8_3", values1, &[PackedM31::one()]);
                let denom0: PackedQM31 = common_lookup_elements.combine(values0);
                let denom1: PackedQM31 = common_lookup_elements.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor8b_2", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor8b_3", values1, &[PackedM31::one()]);
                let denom0: PackedQM31 = common_lookup_elements.combine(values0);
                let denom1: PackedQM31 = common_lookup_elements.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor7_0", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor9_0", values1, &[PackedM31::one()]);
                let denom0: PackedQM31 = common_lookup_elements.combine(values0);
                let denom1: PackedQM31 = common_lookup_elements.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        ...
        (
            ...
            .into_par_iter()
            .for_each(|(writer, values0, values1)| {
                debug_logup("blake_g/xor7_1", values0, &[PackedM31::one()]);
                debug_logup("blake_g/xor9_1", values1, &[PackedM31::one()]);
                let denom0: PackedQM31 = common_lookup_elements.combine(values0);
                let denom1: PackedQM31 = common_lookup_elements.combine(values1);
                writer.write_frac(denom0 + denom1, denom0 * denom1);
            });
        ...
        // Sum last logup term.
        let mut col_gen = logup_gen.new_col();
        (col_gen.par_iter_mut(), &self.lookup_data.blake_g_0).into_par_iter().enumerate().for_each(
            |(i, (writer, values))| {
                let enabler = enabler_col.packed_at(i);
                debug_logup("blake_g/g_0", values, &[-PackedM31::one() * enabler]);
