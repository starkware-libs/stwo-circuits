...
#![allow(unused_parens)]
use crate::circuit_air::components::range_check_16::{Claim, InteractionClaim, LOG_SIZE, N_TRACE_COLUMNS};
...
fn write_trace_simd(
    ...
    let seq_16 = preprocessed_trace.get_packed_column(&PreProcessedColumnId {
        id: "seq_16".to_owned(),
    });
