...
#![allow(unused_parens)]
use cairo_air::components::range_check_16::{Claim, InteractionClaim, LOG_SIZE, N_TRACE_COLUMNS};
...
fn write_trace_simd(
    ...
    let seq_16 = preprocessed_trace.get_column(&PreProcessedColumnId {
        id: "seq_16".to_owned(),
    });
    ...
    (trace.par_iter_mut(), lookup_data.par_iter_mut())
        ...
        .for_each(|(row_index, (row, lookup_data))| {
            let seq_16 = seq_16.packed_at(row_index);
