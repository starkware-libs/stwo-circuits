...
fn write_trace_simd(
    ...
    (trace.par_iter_mut(), lookup_data.par_iter_mut(), inputs.into_par_iter())
        ...
        .for_each(|(row_index, (row, lookup_data, qm_31_ops_input))| {
            ...
            *row[11] = out_col11;
            *lookup_data.in_0 = [PackedM31::from(GATE_RELATION_ID), in0_address, in0_col0, in0_col1, in0_col2, in0_col3];
            *lookup_data.in_1 = [PackedM31::from(GATE_RELATION_ID), in1_address, in1_col4, in1_col5, in1_col6, in1_col7];
            *lookup_data.out = [PackedM31::from(GATE_RELATION_ID), out_address, out_col8, out_col9, out_col10, out_col11];
