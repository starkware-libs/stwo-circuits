...
#![allow(unused_parens)]
use crate::circuit_air::components::verify_bitwise_xor_9::{
...
impl ClaimGenerator {
    pub fn new(preprocessed_trace: Arc<PreProcessedTrace>) -> Self {
        ...
        let column_ids = [
            PreProcessedColumnId { id: "bitwise_xor_9_0".to_owned() },
            PreProcessedColumnId { id: "bitwise_xor_9_1".to_owned() },
            PreProcessedColumnId { id: "bitwise_xor_9_2".to_owned() },
        ];
...
fn write_trace_simd(
    ...
    let relation_id = PackedM31::broadcast(relations::VERIFY_BITWISE_XOR_9_RELATION_ID);
    let bitwise_xor_9_0 =
    ...
    (trace.par_iter_mut(), lookup_data.par_iter_mut()).into_par_iter().enumerate().for_each(
        |(row_index, (row, lookup_data))| {
            let bitwise_xor_9_0 = bitwise_xor_9_0[row_index];
            let bitwise_xor_9_1 = bitwise_xor_9_1[row_index];
            let bitwise_xor_9_2 = bitwise_xor_9_2[row_index];
            *lookup_data.verify_bitwise_xor_9_0 =
                [relation_id, bitwise_xor_9_0, bitwise_xor_9_1, bitwise_xor_9_2];
            let mult = &mults[0];
    ...
    pub fn write_interaction_trace(
        ...
        (
            ...
            .for_each(|(writer, values, mults_0)| {
                debug_logup("verify_xor_9/0", values, &[-mults_0]);
