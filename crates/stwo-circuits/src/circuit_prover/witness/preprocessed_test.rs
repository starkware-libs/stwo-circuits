...
fn test_generate_empty_preprocessed_trace() {
    ...
    let preprocessed_trace =
        PreProcessedTrace::<SimdBackend>::generate_preprocessed_trace(&circuit).get_trace();
...
fn test_generate_preprocessed_trace() {
    ...
    assert_eq!(preprocessed_trace[0].values.len(), 8);
    assert_eq!(preprocessed_trace[1].values.len(), 8);
    ...
    assert_eq!(preprocessed_trace[8].values.len(), 2);
    assert_eq!(preprocessed_trace[9].values.len(), 2);
    expect![[r#"
