...
// TODO(alon): Use these constants (instead of hardcoded values) where needed.
pub const GATE_RELATION_ID: M31 = M31::from_u32_unchecked(0);
pub const VERIFY_BITWISE_XOR_12_RELATION_ID: M31 = M31::from_u32_unchecked(1);
...
pub const VERIFY_BITWISE_XOR_8_B_RELATION_ID: M31 = M31::from_u32_unchecked(6);
