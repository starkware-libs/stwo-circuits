...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[M31_1058718565.clone(), seq_15.clone()],
        ));
...
//     use super::*;
//     use crate::components::constraints_regression_test_values::RANGE_CHECK_15;

//     #[test]
//     fn range_check_15_constraints_regression() {
...
//         RANGE_CHECK_15.assert_debug_eq(&sum);
//     }
// }
