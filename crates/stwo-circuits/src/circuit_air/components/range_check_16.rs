...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let seq_16 = eval.get_preprocessed_column(PreProcessedColumnId { id: "seq_16".to_owned() });
        let multiplicity_0 = eval.next_trace_mask();

        eval.add_to_relation(RelationEntry::new(
            &self.common_lookup_elements,
            -E::EF::from(multiplicity_0),
            &[M31_1008385708.clone(), seq_16.clone()],
        ));
...
//     use super::*;
//     use crate::components::constraints_regression_test_values::RANGE_CHECK_16;

//     #[test]
//     fn range_check_16_constraints_regression() {
...
//         RANGE_CHECK_16.assert_debug_eq(&sum);
//     }
// }
