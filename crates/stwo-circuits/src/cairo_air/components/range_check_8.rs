...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let seq_8 = acc.get_preprocessed_column(&PreProcessedColumnId { id: "seq_8".to_owned() });

    // Yield RangeCheck_8.
    let tuple_0 = &[eval!(context, 1420243005), eval!(context, seq_8)];
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([(
            PreProcessedColumnId { id: "seq_8".to_owned() },
            context.constant(qm31_from_u32s(1031919509, 939093766, 2028410799, 865942395)),
        )]);
        ...
        assert_eq!(result_value, RANGE_CHECK_8_SAMPLE_EVAL_RESULT)
    }
}
