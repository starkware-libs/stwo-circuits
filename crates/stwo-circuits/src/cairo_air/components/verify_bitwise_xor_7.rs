    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([
            (
                ...
                context.constant(qm31_from_u32s(181664839, 625954933, 1973648388, 1503075109)),
            ),
            (
                PreProcessedColumnId { id: "bitwise_xor_7_1".to_owned() },
                context.constant(qm31_from_u32s(114555660, 491737205, 1906539524, 1503075109)),
            ),
            (
                PreProcessedColumnId { id: "bitwise_xor_7_2".to_owned() },
                context.constant(qm31_from_u32s(315883197, 894390389, 2107866116, 1503075109)),
            ),
        ]);
        ...
        assert_eq!(result_value, VERIFY_BITWISE_XOR_7_SAMPLE_EVAL_RESULT)
    }
}
