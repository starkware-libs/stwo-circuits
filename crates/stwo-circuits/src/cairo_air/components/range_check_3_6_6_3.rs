...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let range_check_3_6_6_3_column_0 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_3_6_6_3_column_0".to_owned(),
    });
    let range_check_3_6_6_3_column_1 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_3_6_6_3_column_1".to_owned(),
    });
    let range_check_3_6_6_3_column_2 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_3_6_6_3_column_2".to_owned(),
    });
    let range_check_3_6_6_3_column_3 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_3_6_6_3_column_3".to_owned(),
    });

    // Yield RangeCheck_3_6_6_3.
    let tuple_0 = &[
        eval!(context, 1005786011),
        eval!(context, range_check_3_6_6_3_column_0),
        eval!(context, range_check_3_6_6_3_column_1),
        eval!(context, range_check_3_6_6_3_column_2),
        eval!(context, range_check_3_6_6_3_column_3),
    ];
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([
            (
                PreProcessedColumnId { id: "range_check_3_6_6_3_column_0".to_owned() },
                context.constant(qm31_from_u32s(802513802, 1922585512, 1089386476, 1846978329)),
            ),
            (
                PreProcessedColumnId { id: "range_check_3_6_6_3_column_1".to_owned() },
                context.constant(qm31_from_u32s(735404623, 1788367784, 1022277612, 1846978329)),
            ),
            (
                PreProcessedColumnId { id: "range_check_3_6_6_3_column_2".to_owned() },
                context.constant(qm31_from_u32s(936732160, 43537321, 1223604205, 1846978329)),
            ),
            (
                PreProcessedColumnId { id: "range_check_3_6_6_3_column_3".to_owned() },
                context.constant(qm31_from_u32s(869622981, 2056803240, 1156495340, 1846978329)),
            ),
        ]);
        ...
        assert_eq!(result_value, RANGE_CHECK_3_6_6_3_SAMPLE_EVAL_RESULT)
    }
}
