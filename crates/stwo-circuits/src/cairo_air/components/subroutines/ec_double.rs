...
pub fn accumulate_constraints(
    ...
    verify_mul_252::accumulate_constraints(
        &[
            ...
            eval!(context, add_res_limb_26_col82),
            eval!(context, add_res_limb_27_col83),
            eval!(context, ((3) * (mul_res_limb_0_col0)) + (1)),
            eval!(context, (3) * (mul_res_limb_1_col1)),
            eval!(context, (3) * (mul_res_limb_2_col2)),
            eval!(context, (3) * (mul_res_limb_3_col3)),
            eval!(context, (3) * (mul_res_limb_4_col4)),
            eval!(context, (3) * (mul_res_limb_5_col5)),
            eval!(context, (3) * (mul_res_limb_6_col6)),
            eval!(context, (3) * (mul_res_limb_7_col7)),
            eval!(context, (3) * (mul_res_limb_8_col8)),
            eval!(context, (3) * (mul_res_limb_9_col9)),
            eval!(context, (3) * (mul_res_limb_10_col10)),
            eval!(context, (3) * (mul_res_limb_11_col11)),
            eval!(context, (3) * (mul_res_limb_12_col12)),
            eval!(context, (3) * (mul_res_limb_13_col13)),
            eval!(context, (3) * (mul_res_limb_14_col14)),
            eval!(context, (3) * (mul_res_limb_15_col15)),
            eval!(context, (3) * (mul_res_limb_16_col16)),
            eval!(context, (3) * (mul_res_limb_17_col17)),
            eval!(context, (3) * (mul_res_limb_18_col18)),
            eval!(context, (3) * (mul_res_limb_19_col19)),
            eval!(context, (3) * (mul_res_limb_20_col20)),
            eval!(context, (3) * (mul_res_limb_21_col21)),
            eval!(context, (3) * (mul_res_limb_22_col22)),
            eval!(context, (3) * (mul_res_limb_23_col23)),
            eval!(context, (3) * (mul_res_limb_24_col24)),
            eval!(context, (3) * (mul_res_limb_25_col25)),
            eval!(context, (3) * (mul_res_limb_26_col26)),
            eval!(context, (3) * (mul_res_limb_27_col27)),
    ...
    verify_mul_252::accumulate_constraints(
        &[
            ...
            eval!(
                context,
                ((ec_double_input_x_limb_0) + (ec_double_input_x_limb_0))
                    + (result_x_limb_0_col141)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_1) + (ec_double_input_x_limb_1))
                    + (result_x_limb_1_col142)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_2) + (ec_double_input_x_limb_2))
                    + (result_x_limb_2_col143)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_3) + (ec_double_input_x_limb_3))
                    + (result_x_limb_3_col144)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_4) + (ec_double_input_x_limb_4))
                    + (result_x_limb_4_col145)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_5) + (ec_double_input_x_limb_5))
                    + (result_x_limb_5_col146)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_6) + (ec_double_input_x_limb_6))
                    + (result_x_limb_6_col147)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_7) + (ec_double_input_x_limb_7))
                    + (result_x_limb_7_col148)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_8) + (ec_double_input_x_limb_8))
                    + (result_x_limb_8_col149)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_9) + (ec_double_input_x_limb_9))
                    + (result_x_limb_9_col150)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_10) + (ec_double_input_x_limb_10))
                    + (result_x_limb_10_col151)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_11) + (ec_double_input_x_limb_11))
                    + (result_x_limb_11_col152)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_12) + (ec_double_input_x_limb_12))
                    + (result_x_limb_12_col153)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_13) + (ec_double_input_x_limb_13))
                    + (result_x_limb_13_col154)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_14) + (ec_double_input_x_limb_14))
                    + (result_x_limb_14_col155)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_15) + (ec_double_input_x_limb_15))
                    + (result_x_limb_15_col156)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_16) + (ec_double_input_x_limb_16))
                    + (result_x_limb_16_col157)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_17) + (ec_double_input_x_limb_17))
                    + (result_x_limb_17_col158)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_18) + (ec_double_input_x_limb_18))
                    + (result_x_limb_18_col159)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_19) + (ec_double_input_x_limb_19))
                    + (result_x_limb_19_col160)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_20) + (ec_double_input_x_limb_20))
                    + (result_x_limb_20_col161)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_21) + (ec_double_input_x_limb_21))
                    + (result_x_limb_21_col162)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_22) + (ec_double_input_x_limb_22))
                    + (result_x_limb_22_col163)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_23) + (ec_double_input_x_limb_23))
                    + (result_x_limb_23_col164)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_24) + (ec_double_input_x_limb_24))
                    + (result_x_limb_24_col165)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_25) + (ec_double_input_x_limb_25))
                    + (result_x_limb_25_col166)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_26) + (ec_double_input_x_limb_26))
                    + (result_x_limb_26_col167)
            ),
            eval!(
                context,
                ((ec_double_input_x_limb_27) + (ec_double_input_x_limb_27))
                    + (result_x_limb_27_col168)
            ),
