...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([(
            PreProcessedColumnId { id: "seq_18".to_owned() },
            context.constant(qm31_from_u32s(1762460761, 988762144, 1264441287, 1758380471)),
        )]);
        ...
        assert_eq!(result_value, RANGE_CHECK_18_SAMPLE_EVAL_RESULT)
    }
}
