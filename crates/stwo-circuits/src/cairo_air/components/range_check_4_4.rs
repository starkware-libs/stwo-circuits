...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let range_check_4_4_column_0 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_4_4_column_0".to_owned(),
    });
    let range_check_4_4_column_1 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_4_4_column_1".to_owned(),
    });

    // Yield RangeCheck_4_4.
    let tuple_0 = &[
        eval!(context, 1651211826),
        eval!(context, range_check_4_4_column_0),
        eval!(context, range_check_4_4_column_1),
    ];
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([
            (
                PreProcessedColumnId { id: "range_check_4_4_column_0".to_owned() },
                context.constant(qm31_from_u32s(1928260429, 15680291, 139619331, 637239059)),
            ),
            (
                PreProcessedColumnId { id: "range_check_4_4_column_1".to_owned() },
                context.constant(qm31_from_u32s(1861151250, 2028946210, 72510466, 637239059)),
            ),
        ]);
        ...
        assert_eq!(result_value, RANGE_CHECK_4_4_SAMPLE_EVAL_RESULT)
    }
}
