    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([
            (
                ...
                context.constant(qm31_from_u32s(1060746328, 1436216900, 828049526, 340185758)),
            ),
            (
                PreProcessedColumnId { id: "range_check_4_4_4_4_column_1".to_owned() },
                context.constant(qm31_from_u32s(993637149, 1301999172, 760940662, 340185758)),
            ),
            (
                PreProcessedColumnId { id: "range_check_4_4_4_4_column_2".to_owned() },
                context.constant(qm31_from_u32s(1194964686, 1704652356, 962267254, 340185758)),
            ),
            (
                PreProcessedColumnId { id: "range_check_4_4_4_4_column_3".to_owned() },
                context.constant(qm31_from_u32s(1127855507, 1570434628, 895158390, 340185758)),
            ),
        ]);
        ...
        assert_eq!(result_value, RANGE_CHECK_4_4_4_4_SAMPLE_EVAL_RESULT)
    }
}
