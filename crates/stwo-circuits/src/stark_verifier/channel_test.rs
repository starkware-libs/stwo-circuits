...
fn test_mix_root_regression() {
    ...
    channel.mix_root(&mut context, root0);
    let digest0 = channel.digest;
    channel.mix_root(&mut context, root1);
    ...
    assert_eq!(context.stats, Stats { blake: 2, guess: 2, ..Stats::default() });
