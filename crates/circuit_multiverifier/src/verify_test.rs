...
const PRIVACY_CAIRO_VERIFIER_N_PREPROCESSED_COLUMNS: usize = 45;
...
const MULTIVERIFIER_N_PREPROCESSED_COLUMNS: usize = PRIVACY_CAIRO_VERIFIER_N_PREPROCESSED_COLUMNS;
