...
const PRIVACY_CAIRO_VERIFIER_PREPROCESSED_ROOT: [u32; 8] =
    [1953150696, 1700017712, 212052440, 647992904, 1794866890, 415318462, 32633298, 656020370];
...
const MULTIVERIFIER_PREPROCESSED_ROOT: [u32; 8] =
    [170154234, 1056576393, 1254746858, 620432319, 2045742148, 1063031682, 1464098778, 2122199063];
