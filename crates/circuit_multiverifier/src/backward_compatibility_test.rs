...
/// The output values of the Cairo verifier circuit as it was at commit 9ab9447.
...
fn test_backward_compatibility() {
    ...
    let old_input = MultiverifierInput {
        ...
        output_values: BACKWARD_COMPATIBILITY_CAIRO_VERIFIER_OUTPUT_VALUES.map(QM31::pack_u32),
