...
// multiverifier test modules (`verify_test` and `backward_compatability_test`).
...
/// The preprocessed root of the (current) privacy Cairo verifier circuit.
...
/// The preprocessed root of the (current) multiverifier circuit.
...
/// A (current) multiverifier proof verifying two identical Cairo verifier proofs.
