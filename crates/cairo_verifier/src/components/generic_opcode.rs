...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let [
        ...
        res_add_col12,
        res_mul_col13,
        pc_update_jump_col14,
        pc_update_jump_rel_col15,
        pc_update_jnz_col16,
        ap_update_add_col17,
        ap_update_add_1_col18,
        opcode_call_col19,
        opcode_ret_col20,
        opcode_assert_eq_col21,
        dst_src_col22,
        dst_id_col23,
        dst_limb_0_col24,
        dst_limb_1_col25,
        ...
        op1_limb_26_col111,
        op1_limb_27_col112,
        add_res_limb_0_col113,
        add_res_limb_1_col114,
        add_res_limb_2_col115,
        add_res_limb_3_col116,
        add_res_limb_4_col117,
        add_res_limb_5_col118,
        add_res_limb_6_col119,
        add_res_limb_7_col120,
        add_res_limb_8_col121,
        add_res_limb_9_col122,
        add_res_limb_10_col123,
        add_res_limb_11_col124,
        add_res_limb_12_col125,
        add_res_limb_13_col126,
        add_res_limb_14_col127,
        add_res_limb_15_col128,
        add_res_limb_16_col129,
        add_res_limb_17_col130,
        add_res_limb_18_col131,
        add_res_limb_19_col132,
        add_res_limb_20_col133,
        add_res_limb_21_col134,
        add_res_limb_22_col135,
        add_res_limb_23_col136,
        add_res_limb_24_col137,
        add_res_limb_25_col138,
        add_res_limb_26_col139,
        add_res_limb_27_col140,
        sub_p_bit_col141,
        mul_res_limb_0_col142,
        mul_res_limb_1_col143,
        mul_res_limb_2_col144,
        mul_res_limb_3_col145,
        mul_res_limb_4_col146,
        mul_res_limb_5_col147,
        mul_res_limb_6_col148,
        mul_res_limb_7_col149,
        mul_res_limb_8_col150,
        mul_res_limb_9_col151,
        mul_res_limb_10_col152,
        mul_res_limb_11_col153,
        mul_res_limb_12_col154,
        mul_res_limb_13_col155,
        mul_res_limb_14_col156,
        mul_res_limb_15_col157,
        mul_res_limb_16_col158,
        mul_res_limb_17_col159,
        mul_res_limb_18_col160,
        mul_res_limb_19_col161,
        mul_res_limb_20_col162,
        mul_res_limb_21_col163,
        mul_res_limb_22_col164,
        mul_res_limb_23_col165,
        mul_res_limb_24_col166,
        mul_res_limb_25_col167,
        mul_res_limb_26_col168,
        mul_res_limb_27_col169,
        k_col170,
        carry_0_col171,
        carry_1_col172,
        carry_2_col173,
        ...
        next_pc_col239,
        next_ap_col240,
        range_check_29_bot11bits_col241,
        next_fp_col242,
    ...
    let [
        ...
        &[
            ...
            eval!(context, op1_base_ap_col11),
            eval!(context, res_add_col12),
            eval!(context, res_mul_col13),
            eval!(context, pc_update_jump_col14),
            eval!(context, pc_update_jump_rel_col15),
            eval!(context, pc_update_jnz_col16),
            eval!(context, ap_update_add_col17),
            eval!(context, ap_update_add_1_col18),
            eval!(context, opcode_call_col19),
            eval!(context, opcode_ret_col20),
            eval!(context, opcode_assert_eq_col21),
        ],
        context,
        component_data,
        acc,
    ...
    eval_operands::accumulate_constraints(
        &[
            ...
            eval!(context, res_mul_col13),
            eval!(context, pc_update_jnz_col16),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_op1_base_op0),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_res_op1),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_offset0),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_offset1),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_offset2),
            eval!(context, enabler_col0),
            eval!(context, dst_src_col22),
            eval!(context, dst_id_col23),
            eval!(context, dst_limb_0_col24),
            eval!(context, dst_limb_1_col25),
            eval!(context, dst_limb_2_col26),
            eval!(context, dst_limb_3_col27),
            eval!(context, dst_limb_4_col28),
            eval!(context, dst_limb_5_col29),
            eval!(context, dst_limb_6_col30),
            eval!(context, dst_limb_7_col31),
            eval!(context, dst_limb_8_col32),
            eval!(context, dst_limb_9_col33),
            eval!(context, dst_limb_10_col34),
            eval!(context, dst_limb_11_col35),
            eval!(context, dst_limb_12_col36),
            eval!(context, dst_limb_13_col37),
            eval!(context, dst_limb_14_col38),
            eval!(context, dst_limb_15_col39),
            eval!(context, dst_limb_16_col40),
            eval!(context, dst_limb_17_col41),
            eval!(context, dst_limb_18_col42),
            eval!(context, dst_limb_19_col43),
            eval!(context, dst_limb_20_col44),
            eval!(context, dst_limb_21_col45),
            eval!(context, dst_limb_22_col46),
            eval!(context, dst_limb_23_col47),
            eval!(context, dst_limb_24_col48),
            eval!(context, dst_limb_25_col49),
            eval!(context, dst_limb_26_col50),
            eval!(context, dst_limb_27_col51),
            eval!(context, op0_src_col52),
            eval!(context, op0_id_col53),
            eval!(context, op0_limb_0_col54),
            eval!(context, op0_limb_1_col55),
            eval!(context, op0_limb_2_col56),
            eval!(context, op0_limb_3_col57),
            eval!(context, op0_limb_4_col58),
            eval!(context, op0_limb_5_col59),
            eval!(context, op0_limb_6_col60),
            eval!(context, op0_limb_7_col61),
            eval!(context, op0_limb_8_col62),
            eval!(context, op0_limb_9_col63),
            eval!(context, op0_limb_10_col64),
            eval!(context, op0_limb_11_col65),
            eval!(context, op0_limb_12_col66),
            eval!(context, op0_limb_13_col67),
            eval!(context, op0_limb_14_col68),
            eval!(context, op0_limb_15_col69),
            eval!(context, op0_limb_16_col70),
            eval!(context, op0_limb_17_col71),
            eval!(context, op0_limb_18_col72),
            eval!(context, op0_limb_19_col73),
            eval!(context, op0_limb_20_col74),
            eval!(context, op0_limb_21_col75),
            eval!(context, op0_limb_22_col76),
            eval!(context, op0_limb_23_col77),
            eval!(context, op0_limb_24_col78),
            eval!(context, op0_limb_25_col79),
            eval!(context, op0_limb_26_col80),
            eval!(context, op0_limb_27_col81),
            eval!(context, partial_limb_msb_col82),
            eval!(context, op1_src_col83),
            eval!(context, op1_id_col84),
            eval!(context, op1_limb_0_col85),
            eval!(context, op1_limb_1_col86),
            eval!(context, op1_limb_2_col87),
            eval!(context, op1_limb_3_col88),
            eval!(context, op1_limb_4_col89),
            eval!(context, op1_limb_5_col90),
            eval!(context, op1_limb_6_col91),
            eval!(context, op1_limb_7_col92),
            eval!(context, op1_limb_8_col93),
            eval!(context, op1_limb_9_col94),
            eval!(context, op1_limb_10_col95),
            eval!(context, op1_limb_11_col96),
            eval!(context, op1_limb_12_col97),
            eval!(context, op1_limb_13_col98),
            eval!(context, op1_limb_14_col99),
            eval!(context, op1_limb_15_col100),
            eval!(context, op1_limb_16_col101),
            eval!(context, op1_limb_17_col102),
            eval!(context, op1_limb_18_col103),
            eval!(context, op1_limb_19_col104),
            eval!(context, op1_limb_20_col105),
            eval!(context, op1_limb_21_col106),
            eval!(context, op1_limb_22_col107),
            eval!(context, op1_limb_23_col108),
            eval!(context, op1_limb_24_col109),
            eval!(context, op1_limb_25_col110),
            eval!(context, op1_limb_26_col111),
            eval!(context, op1_limb_27_col112),
            eval!(context, add_res_limb_0_col113),
            eval!(context, add_res_limb_1_col114),
            eval!(context, add_res_limb_2_col115),
            eval!(context, add_res_limb_3_col116),
            eval!(context, add_res_limb_4_col117),
            eval!(context, add_res_limb_5_col118),
            eval!(context, add_res_limb_6_col119),
            eval!(context, add_res_limb_7_col120),
            eval!(context, add_res_limb_8_col121),
            eval!(context, add_res_limb_9_col122),
            eval!(context, add_res_limb_10_col123),
            eval!(context, add_res_limb_11_col124),
            eval!(context, add_res_limb_12_col125),
            eval!(context, add_res_limb_13_col126),
            eval!(context, add_res_limb_14_col127),
            eval!(context, add_res_limb_15_col128),
            eval!(context, add_res_limb_16_col129),
            eval!(context, add_res_limb_17_col130),
            eval!(context, add_res_limb_18_col131),
            eval!(context, add_res_limb_19_col132),
            eval!(context, add_res_limb_20_col133),
            eval!(context, add_res_limb_21_col134),
            eval!(context, add_res_limb_22_col135),
            eval!(context, add_res_limb_23_col136),
            eval!(context, add_res_limb_24_col137),
            eval!(context, add_res_limb_25_col138),
            eval!(context, add_res_limb_26_col139),
            eval!(context, add_res_limb_27_col140),
            eval!(context, sub_p_bit_col141),
            eval!(context, mul_res_limb_0_col142),
            eval!(context, mul_res_limb_1_col143),
            eval!(context, mul_res_limb_2_col144),
            eval!(context, mul_res_limb_3_col145),
            eval!(context, mul_res_limb_4_col146),
            eval!(context, mul_res_limb_5_col147),
            eval!(context, mul_res_limb_6_col148),
            eval!(context, mul_res_limb_7_col149),
            eval!(context, mul_res_limb_8_col150),
            eval!(context, mul_res_limb_9_col151),
            eval!(context, mul_res_limb_10_col152),
            eval!(context, mul_res_limb_11_col153),
            eval!(context, mul_res_limb_12_col154),
            eval!(context, mul_res_limb_13_col155),
            eval!(context, mul_res_limb_14_col156),
            eval!(context, mul_res_limb_15_col157),
            eval!(context, mul_res_limb_16_col158),
            eval!(context, mul_res_limb_17_col159),
            eval!(context, mul_res_limb_18_col160),
            eval!(context, mul_res_limb_19_col161),
            eval!(context, mul_res_limb_20_col162),
            eval!(context, mul_res_limb_21_col163),
            eval!(context, mul_res_limb_22_col164),
            eval!(context, mul_res_limb_23_col165),
            eval!(context, mul_res_limb_24_col166),
            eval!(context, mul_res_limb_25_col167),
            eval!(context, mul_res_limb_26_col168),
            eval!(context, mul_res_limb_27_col169),
            ...
            eval!(context, res_limb_0_col198),
            eval!(context, res_limb_1_col199),
            eval!(context, res_limb_2_col200),
            eval!(context, res_limb_3_col201),
            eval!(context, res_limb_4_col202),
            eval!(context, res_limb_5_col203),
            eval!(context, res_limb_6_col204),
            eval!(context, res_limb_7_col205),
            eval!(context, res_limb_8_col206),
            eval!(context, res_limb_9_col207),
            eval!(context, res_limb_10_col208),
            eval!(context, res_limb_11_col209),
            eval!(context, res_limb_12_col210),
            eval!(context, res_limb_13_col211),
            eval!(context, res_limb_14_col212),
            eval!(context, res_limb_15_col213),
            eval!(context, res_limb_16_col214),
            eval!(context, res_limb_17_col215),
            eval!(context, res_limb_18_col216),
            eval!(context, res_limb_19_col217),
            eval!(context, res_limb_20_col218),
            eval!(context, res_limb_21_col219),
            eval!(context, res_limb_22_col220),
            eval!(context, res_limb_23_col221),
            eval!(context, res_limb_24_col222),
            eval!(context, res_limb_25_col223),
            eval!(context, res_limb_26_col224),
            eval!(context, res_limb_27_col225),
        ],
        context,
        component_data,
        acc,
    ...
    handle_opcodes::accumulate_constraints(
        &[
            ...
            eval!(context, opcode_assert_eq_col21),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_res_op1),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_instruction_size),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_offset0),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_offset1),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_offset2),
            eval!(context, dst_limb_0_col24),
    ...
    update_registers::accumulate_constraints(
        &[
            ...
            eval!(context, opcode_call_col19),
            eval!(context, opcode_ret_col20),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_pc_update_regular),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_fp_update_regular),
            eval!(context, decode_generic_instruction_output_tmp_c8168_26_instruction_size),
            eval!(context, dst_limb_0_col24),
            eval!(context, dst_limb_1_col25),
            eval!(context, dst_limb_2_col26),
            ...
            eval!(context, res_limb_27_col225),
            eval!(context, enabler_col0),
            eval!(context, partial_limb_msb_col228),
            eval!(context, msb_col229),
            eval!(context, mid_limbs_set_col230),
            eval!(context, partial_limb_msb_col231),
            eval!(context, dst_sum_squares_inv_col232),
            eval!(context, dst_sum_inv_col233),
            eval!(context, op1_as_rel_imm_cond_col234),
            eval!(context, msb_col235),
            eval!(context, mid_limbs_set_col236),
            eval!(context, partial_limb_msb_col237),
            eval!(context, next_pc_jnz_col238),
            eval!(context, next_pc_col239),
            eval!(context, next_ap_col240),
            eval!(context, range_check_29_bot11bits_col241),
            eval!(context, next_fp_col242),
        ],
        context,
        component_data,
        acc,
