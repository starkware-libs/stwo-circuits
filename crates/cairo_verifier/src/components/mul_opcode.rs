...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let constraint_1_value = eval!(
        context,
        (op1_imm_col8) * ((1) - (decode_instruction_c630b_output_tmp_93be2_11_offset2))
    );
    ...
    let constraint_4_value = eval!(
        ...
        (mem1_base_col13)
            - ((((op1_imm_col8) * (input_pc_col0)) + ((op1_base_fp_col9) * (input_fp_col2)))
                + ((decode_instruction_c630b_output_tmp_93be2_11_op1_base_ap) * (input_ap_col1)))
    );
    ...
    read_positive_num_bits_252::accumulate_constraints(
        &[
            eval!(
                context,
                (mem_dst_base_col11) + (decode_instruction_c630b_output_tmp_93be2_11_offset0)
            ),
    ...
    read_positive_num_bits_252::accumulate_constraints(
        &[
            eval!(
                context,
                (mem0_base_col12) + (decode_instruction_c630b_output_tmp_93be2_11_offset1)
            ),
    ...
    read_positive_num_bits_252::accumulate_constraints(
        &[
            eval!(
                context,
                (mem1_base_col13) + (decode_instruction_c630b_output_tmp_93be2_11_offset2)
            ),
    ...
    let constraint_9_value =
        eval!(context, ((enabler_col129) * (enabler_col129)) - (enabler_col129));
    ...
    let numerator_10 = eval!(context, enabler_col129);
    ...
    let numerator_11 = eval!(context, -(enabler_col129));
