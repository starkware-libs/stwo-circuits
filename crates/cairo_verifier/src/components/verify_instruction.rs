...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let [encode_offsets_output_tmp_40a8f_8_limb_1, encode_offsets_output_tmp_40a8f_8_limb_3] =
        encode_offsets::accumulate_constraints(
            &[
                eval!(context, input_offset0_col2),
                eval!(context, input_offset1_col3),
                eval!(context, input_offset2_col4),
                eval!(context, 1),
                eval!(context, offset0_low_col8),
                eval!(context, offset0_mid_col9),
                eval!(context, offset1_low_col10),
                eval!(context, offset1_mid_col11),
                eval!(context, offset1_high_col12),
                eval!(context, offset2_low_col13),
                eval!(context, offset2_mid_col14),
                eval!(context, offset2_high_col15),
            ],
            context,
            component_data,
            acc,
    ...
    mem_verify::accumulate_constraints(
        &[
            ...
            eval!(context, offset0_low_col8),
            eval!(context, encode_offsets_output_tmp_40a8f_8_limb_1),
            eval!(context, offset1_mid_col11),
            eval!(context, encode_offsets_output_tmp_40a8f_8_limb_3),
            eval!(context, offset2_mid_col14),
            eval!(context, (offset2_high_col15) + (input_inst_felt5_high_col5)),
            eval!(context, input_inst_felt6_col6),
            eval!(context, input_opcode_extension_col7),
            eval!(context, 0),
            eval!(context, 0),
            eval!(context, 0),
            eval!(context, 0),
            ...
            eval!(context, 0),
            eval!(context, 1),
            eval!(context, instruction_id_col16),
        ],
        context,
        component_data,
        acc,
    ...
    let tuple_2 = &[
        ...
        eval!(context, input_offset1_col3),
        eval!(context, input_offset2_col4),
        eval!(context, input_inst_felt5_high_col5),
        eval!(context, input_inst_felt6_col6),
        eval!(context, input_opcode_extension_col7),
    ];
    let numerator_2 = eval!(context, -(multiplicity_0_col0));
