...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let [
        ...
        mul_res_limb_0_col29,
        mul_res_limb_1_col30,
        mul_res_limb_2_col31,
        mul_res_limb_3_col32,
        mul_res_limb_4_col33,
        mul_res_limb_5_col34,
        mul_res_limb_6_col35,
        mul_res_limb_7_col36,
        mul_res_limb_8_col37,
        mul_res_limb_9_col38,
        mul_res_limb_10_col39,
        mul_res_limb_11_col40,
        mul_res_limb_12_col41,
        mul_res_limb_13_col42,
        mul_res_limb_14_col43,
        mul_res_limb_15_col44,
        mul_res_limb_16_col45,
        mul_res_limb_17_col46,
        mul_res_limb_18_col47,
        mul_res_limb_19_col48,
        mul_res_limb_20_col49,
        mul_res_limb_21_col50,
        mul_res_limb_22_col51,
        mul_res_limb_23_col52,
        mul_res_limb_24_col53,
        mul_res_limb_25_col54,
        mul_res_limb_26_col55,
        mul_res_limb_27_col56,
        k_col57,
        carry_0_col58,
        carry_1_col59,
        carry_2_col60,
        ...
        carry_25_col83,
        carry_26_col84,
        mul_res_limb_0_col85,
        mul_res_limb_1_col86,
        mul_res_limb_2_col87,
        mul_res_limb_3_col88,
        mul_res_limb_4_col89,
        mul_res_limb_5_col90,
        mul_res_limb_6_col91,
        mul_res_limb_7_col92,
        mul_res_limb_8_col93,
        mul_res_limb_9_col94,
        mul_res_limb_10_col95,
        mul_res_limb_11_col96,
        mul_res_limb_12_col97,
        mul_res_limb_13_col98,
        mul_res_limb_14_col99,
        mul_res_limb_15_col100,
        mul_res_limb_16_col101,
        mul_res_limb_17_col102,
        mul_res_limb_18_col103,
        mul_res_limb_19_col104,
        mul_res_limb_20_col105,
        mul_res_limb_21_col106,
        mul_res_limb_22_col107,
        mul_res_limb_23_col108,
        mul_res_limb_24_col109,
        mul_res_limb_25_col110,
        mul_res_limb_26_col111,
    ...
    let [
        ...
        &[
            ...
            eval!(context, unpacked_limb_0_col11),
            eval!(context, unpacked_limb_1_col12),
            eval!(context, unpacked_limb_3_col13),
            eval!(context, unpacked_limb_4_col14),
            eval!(context, unpacked_limb_6_col15),
            eval!(context, unpacked_limb_7_col16),
            eval!(context, unpacked_limb_9_col17),
            eval!(context, unpacked_limb_10_col18),
            eval!(context, unpacked_limb_12_col19),
            eval!(context, unpacked_limb_13_col20),
            eval!(context, unpacked_limb_15_col21),
            eval!(context, unpacked_limb_16_col22),
            eval!(context, unpacked_limb_18_col23),
            eval!(context, unpacked_limb_19_col24),
            eval!(context, unpacked_limb_21_col25),
            eval!(context, unpacked_limb_22_col26),
            eval!(context, unpacked_limb_24_col27),
            eval!(context, unpacked_limb_25_col28),
        ],
        context,
        component_data,
        acc,
    ...
    mul_252::accumulate_constraints(
        &[
            eval!(context, unpacked_limb_0_col11),
            eval!(context, unpacked_limb_1_col12),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_2),
            eval!(context, unpacked_limb_3_col13),
            eval!(context, unpacked_limb_4_col14),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_5),
            eval!(context, unpacked_limb_6_col15),
            eval!(context, unpacked_limb_7_col16),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_8),
            eval!(context, unpacked_limb_9_col17),
            eval!(context, unpacked_limb_10_col18),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_11),
            eval!(context, unpacked_limb_12_col19),
            eval!(context, unpacked_limb_13_col20),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_14),
            eval!(context, unpacked_limb_15_col21),
            eval!(context, unpacked_limb_16_col22),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_17),
            eval!(context, unpacked_limb_18_col23),
            eval!(context, unpacked_limb_19_col24),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_20),
            eval!(context, unpacked_limb_21_col25),
            eval!(context, unpacked_limb_22_col26),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_23),
            eval!(context, unpacked_limb_24_col27),
            eval!(context, unpacked_limb_25_col28),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_26),
            eval!(context, input_limb_9_col10),
            eval!(context, unpacked_limb_0_col11),
            eval!(context, unpacked_limb_1_col12),
            eval!(context, felt_252_unpack_from_27_range_check_output_output_tmp_715f4_2_limb_2),
            ...
            eval!(context, input_limb_9_col10),
            eval!(context, enabler_col0),
            eval!(context, mul_res_limb_0_col29),
            eval!(context, mul_res_limb_1_col30),
            eval!(context, mul_res_limb_2_col31),
            eval!(context, mul_res_limb_3_col32),
            eval!(context, mul_res_limb_4_col33),
            eval!(context, mul_res_limb_5_col34),
            eval!(context, mul_res_limb_6_col35),
            eval!(context, mul_res_limb_7_col36),
            eval!(context, mul_res_limb_8_col37),
            eval!(context, mul_res_limb_9_col38),
            eval!(context, mul_res_limb_10_col39),
            eval!(context, mul_res_limb_11_col40),
            eval!(context, mul_res_limb_12_col41),
            eval!(context, mul_res_limb_13_col42),
            eval!(context, mul_res_limb_14_col43),
            eval!(context, mul_res_limb_15_col44),
            eval!(context, mul_res_limb_16_col45),
            eval!(context, mul_res_limb_17_col46),
            eval!(context, mul_res_limb_18_col47),
            eval!(context, mul_res_limb_19_col48),
            eval!(context, mul_res_limb_20_col49),
            eval!(context, mul_res_limb_21_col50),
            eval!(context, mul_res_limb_22_col51),
            eval!(context, mul_res_limb_23_col52),
            eval!(context, mul_res_limb_24_col53),
            eval!(context, mul_res_limb_25_col54),
            eval!(context, mul_res_limb_26_col55),
            eval!(context, mul_res_limb_27_col56),
            eval!(context, k_col57),
            eval!(context, carry_0_col58),
            eval!(context, carry_1_col59),
            eval!(context, carry_2_col60),
            eval!(context, carry_3_col61),
            eval!(context, carry_4_col62),
            eval!(context, carry_5_col63),
            eval!(context, carry_6_col64),
            eval!(context, carry_7_col65),
            eval!(context, carry_8_col66),
            eval!(context, carry_9_col67),
            eval!(context, carry_10_col68),
            eval!(context, carry_11_col69),
            eval!(context, carry_12_col70),
            eval!(context, carry_13_col71),
            eval!(context, carry_14_col72),
            eval!(context, carry_15_col73),
            eval!(context, carry_16_col74),
            eval!(context, carry_17_col75),
            eval!(context, carry_18_col76),
            eval!(context, carry_19_col77),
            eval!(context, carry_20_col78),
            eval!(context, carry_21_col79),
            eval!(context, carry_22_col80),
            eval!(context, carry_23_col81),
            eval!(context, carry_24_col82),
            eval!(context, carry_25_col83),
            eval!(context, carry_26_col84),
        ],
        context,
        component_data,
        acc,
    ...
    mul_252::accumulate_constraints(
        &[
            ...
            eval!(context, mul_res_limb_27_col56),
            eval!(context, enabler_col0),
            eval!(context, mul_res_limb_0_col85),
            eval!(context, mul_res_limb_1_col86),
            eval!(context, mul_res_limb_2_col87),
            eval!(context, mul_res_limb_3_col88),
            eval!(context, mul_res_limb_4_col89),
            eval!(context, mul_res_limb_5_col90),
            eval!(context, mul_res_limb_6_col91),
            eval!(context, mul_res_limb_7_col92),
            eval!(context, mul_res_limb_8_col93),
            eval!(context, mul_res_limb_9_col94),
            eval!(context, mul_res_limb_10_col95),
            eval!(context, mul_res_limb_11_col96),
            eval!(context, mul_res_limb_12_col97),
            eval!(context, mul_res_limb_13_col98),
            eval!(context, mul_res_limb_14_col99),
            eval!(context, mul_res_limb_15_col100),
            eval!(context, mul_res_limb_16_col101),
            eval!(context, mul_res_limb_17_col102),
            eval!(context, mul_res_limb_18_col103),
            eval!(context, mul_res_limb_19_col104),
            eval!(context, mul_res_limb_20_col105),
            eval!(context, mul_res_limb_21_col106),
            eval!(context, mul_res_limb_22_col107),
            eval!(context, mul_res_limb_23_col108),
            eval!(context, mul_res_limb_24_col109),
            eval!(context, mul_res_limb_25_col110),
            eval!(context, mul_res_limb_26_col111),
            eval!(context, mul_res_limb_27_col112),
    ...
    let tuple_4 = &[
        ...
        eval!(
            context,
            ((mul_res_limb_0_col85) + ((mul_res_limb_1_col86) * (512)))
                + ((mul_res_limb_2_col87) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_3_col88) + ((mul_res_limb_4_col89) * (512)))
                + ((mul_res_limb_5_col90) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_6_col91) + ((mul_res_limb_7_col92) * (512)))
                + ((mul_res_limb_8_col93) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_9_col94) + ((mul_res_limb_10_col95) * (512)))
                + ((mul_res_limb_11_col96) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_12_col97) + ((mul_res_limb_13_col98) * (512)))
                + ((mul_res_limb_14_col99) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_15_col100) + ((mul_res_limb_16_col101) * (512)))
                + ((mul_res_limb_17_col102) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_18_col103) + ((mul_res_limb_19_col104) * (512)))
                + ((mul_res_limb_20_col105) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_21_col106) + ((mul_res_limb_22_col107) * (512)))
                + ((mul_res_limb_23_col108) * (262144))
        ),
        eval!(
            context,
            ((mul_res_limb_24_col109) + ((mul_res_limb_25_col110) * (512)))
                + ((mul_res_limb_26_col111) * (262144))
        ),
        eval!(context, mul_res_limb_27_col112),
    ];
