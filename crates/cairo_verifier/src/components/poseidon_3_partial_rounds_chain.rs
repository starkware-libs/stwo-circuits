...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let tuple_1 = &[
        ...
        eval!(context, poseidon_round_keys_output_limb_0_col43),
        eval!(context, poseidon_round_keys_output_limb_1_col44),
        eval!(context, poseidon_round_keys_output_limb_2_col45),
        eval!(context, poseidon_round_keys_output_limb_3_col46),
        eval!(context, poseidon_round_keys_output_limb_4_col47),
        eval!(context, poseidon_round_keys_output_limb_5_col48),
        eval!(context, poseidon_round_keys_output_limb_6_col49),
        eval!(context, poseidon_round_keys_output_limb_7_col50),
        eval!(context, poseidon_round_keys_output_limb_8_col51),
        eval!(context, poseidon_round_keys_output_limb_9_col52),
        eval!(context, poseidon_round_keys_output_limb_10_col53),
        eval!(context, poseidon_round_keys_output_limb_11_col54),
        eval!(context, poseidon_round_keys_output_limb_12_col55),
        eval!(context, poseidon_round_keys_output_limb_13_col56),
        eval!(context, poseidon_round_keys_output_limb_14_col57),
        eval!(context, poseidon_round_keys_output_limb_15_col58),
        eval!(context, poseidon_round_keys_output_limb_16_col59),
        eval!(context, poseidon_round_keys_output_limb_17_col60),
        eval!(context, poseidon_round_keys_output_limb_18_col61),
        eval!(context, poseidon_round_keys_output_limb_19_col62),
        eval!(context, poseidon_round_keys_output_limb_20_col63),
        eval!(context, poseidon_round_keys_output_limb_21_col64),
        eval!(context, poseidon_round_keys_output_limb_22_col65),
        eval!(context, poseidon_round_keys_output_limb_23_col66),
        eval!(context, poseidon_round_keys_output_limb_24_col67),
        eval!(context, poseidon_round_keys_output_limb_25_col68),
        eval!(context, poseidon_round_keys_output_limb_26_col69),
        eval!(context, poseidon_round_keys_output_limb_27_col70),
        eval!(context, poseidon_round_keys_output_limb_28_col71),
        eval!(context, poseidon_round_keys_output_limb_29_col72),
    ];
    ...
    poseidon_partial_round::accumulate_constraints(
        &[
            ...
            eval!(context, cube_252_output_limb_0_col73),
            eval!(context, cube_252_output_limb_1_col74),
            eval!(context, cube_252_output_limb_2_col75),
            eval!(context, cube_252_output_limb_3_col76),
            eval!(context, cube_252_output_limb_4_col77),
            eval!(context, cube_252_output_limb_5_col78),
            eval!(context, cube_252_output_limb_6_col79),
            eval!(context, cube_252_output_limb_7_col80),
            eval!(context, cube_252_output_limb_8_col81),
            eval!(context, cube_252_output_limb_9_col82),
            eval!(context, combination_limb_0_col83),
            eval!(context, combination_limb_1_col84),
            eval!(context, combination_limb_2_col85),
            eval!(context, combination_limb_3_col86),
            eval!(context, combination_limb_4_col87),
            eval!(context, combination_limb_5_col88),
            eval!(context, combination_limb_6_col89),
            eval!(context, combination_limb_7_col90),
            eval!(context, combination_limb_8_col91),
            eval!(context, combination_limb_9_col92),
            eval!(context, p_coef_col93),
    ...
    poseidon_partial_round::accumulate_constraints(
        &[
            ...
            eval!(context, poseidon_round_keys_output_limb_19_col62),
            eval!(context, enabler_col0),
            eval!(context, cube_252_output_limb_0_col105),
            eval!(context, cube_252_output_limb_1_col106),
            eval!(context, cube_252_output_limb_2_col107),
            eval!(context, cube_252_output_limb_3_col108),
            eval!(context, cube_252_output_limb_4_col109),
            eval!(context, cube_252_output_limb_5_col110),
            eval!(context, cube_252_output_limb_6_col111),
            eval!(context, cube_252_output_limb_7_col112),
            eval!(context, cube_252_output_limb_8_col113),
            eval!(context, cube_252_output_limb_9_col114),
            eval!(context, combination_limb_0_col115),
            eval!(context, combination_limb_1_col116),
            eval!(context, combination_limb_2_col117),
            eval!(context, combination_limb_3_col118),
            eval!(context, combination_limb_4_col119),
            eval!(context, combination_limb_5_col120),
            eval!(context, combination_limb_6_col121),
            eval!(context, combination_limb_7_col122),
            eval!(context, combination_limb_8_col123),
            eval!(context, combination_limb_9_col124),
            eval!(context, p_coef_col125),
            eval!(context, combination_limb_0_col126),
            eval!(context, combination_limb_1_col127),
            eval!(context, combination_limb_2_col128),
            eval!(context, combination_limb_3_col129),
            eval!(context, combination_limb_4_col130),
            eval!(context, combination_limb_5_col131),
            eval!(context, combination_limb_6_col132),
            eval!(context, combination_limb_7_col133),
            eval!(context, combination_limb_8_col134),
            eval!(context, combination_limb_9_col135),
            eval!(context, p_coef_col136),
        ],
        context,
        component_data,
        acc,
    ...
    poseidon_partial_round::accumulate_constraints(
        &[
            ...
            eval!(context, poseidon_round_keys_output_limb_29_col72),
            eval!(context, enabler_col0),
            eval!(context, cube_252_output_limb_0_col137),
            eval!(context, cube_252_output_limb_1_col138),
            eval!(context, cube_252_output_limb_2_col139),
            eval!(context, cube_252_output_limb_3_col140),
            eval!(context, cube_252_output_limb_4_col141),
            eval!(context, cube_252_output_limb_5_col142),
            eval!(context, cube_252_output_limb_6_col143),
            eval!(context, cube_252_output_limb_7_col144),
            eval!(context, cube_252_output_limb_8_col145),
            eval!(context, cube_252_output_limb_9_col146),
            eval!(context, combination_limb_0_col147),
            eval!(context, combination_limb_1_col148),
            eval!(context, combination_limb_2_col149),
            eval!(context, combination_limb_3_col150),
            eval!(context, combination_limb_4_col151),
            eval!(context, combination_limb_5_col152),
            eval!(context, combination_limb_6_col153),
            eval!(context, combination_limb_7_col154),
            eval!(context, combination_limb_8_col155),
            eval!(context, combination_limb_9_col156),
            eval!(context, p_coef_col157),
            eval!(context, combination_limb_0_col158),
            eval!(context, combination_limb_1_col159),
            eval!(context, combination_limb_2_col160),
            eval!(context, combination_limb_3_col161),
            eval!(context, combination_limb_4_col162),
            eval!(context, combination_limb_5_col163),
            eval!(context, combination_limb_6_col164),
            eval!(context, combination_limb_7_col165),
            eval!(context, combination_limb_8_col166),
            eval!(context, combination_limb_9_col167),
            eval!(context, p_coef_col168),
        ],
        context,
        component_data,
        acc,
...
impl<Value: IValue> CircuitEval<Value> for Component {
    fn name(&self) -> String {
        "poseidon_3_partial_rounds_chain".to_string()
    }
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        assert_eq!(result_value, POSEIDON_3_PARTIAL_ROUNDS_CHAIN_SAMPLE_EVAL_RESULT)
    }
}
