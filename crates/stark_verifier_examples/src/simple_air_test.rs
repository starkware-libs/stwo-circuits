use circuits_stark_verifier::proof_from_stark_proof::pad_disabled;
use num_traits::Zero;
...
fn verify_simple_proof() {
    ...
    let padded_claimed_sums: Vec<QM31> =
        pad_disabled(&claimed_sums, &COMPONENT_ENABLE_BITS, QM31::zero());
