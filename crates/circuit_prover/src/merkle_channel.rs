...
impl MerkleChannel for MerkleChannelForCircuit {
    ...
    fn mix_root(channel: &mut Self::C, root: Blake2sHash) {
        // Reduce the Merkle root mod `M31::P` before mixing it into the Blake2sM31Channel.
        // The root's words can exceed `M31::P`, but the in-circuit channel represents the root
        // as `M31` limbs.
