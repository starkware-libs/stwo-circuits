...
pub fn write_interaction_trace(
    ...
    let (
        ...
        let eq_log_size = log_sizes[0];
        let qm31_ops_log_size = log_sizes[1];

        let eq_handle = s.spawn(move || {
            eq::write_interaction_trace(eq_log_size, eq_lookup_data, common_lookup_elements)
        });
        let qm31_ops_handle = s.spawn(move || {
        ...
        let blake_gate_handle =
            s.spawn(move || blake_gate.write_interaction_trace(common_lookup_elements));
        let blake_round_handle =
            s.spawn(move || blake_round.write_interaction_trace(common_lookup_elements));
        let blake_round_sigma_handle =
            s.spawn(move || blake_round_sigma.write_interaction_trace(common_lookup_elements));
        let blake_g_handle =
            s.spawn(move || blake_g.write_interaction_trace(common_lookup_elements));
        let blake_output_handle =
            s.spawn(move || blake_output.write_interaction_trace(common_lookup_elements));
        let triple_xor_32_handle =
            s.spawn(move || triple_xor_32.write_interaction_trace(common_lookup_elements));
        let verify_bitwise_xor_8_handle =
            s.spawn(move || verify_bitwise_xor_8.write_interaction_trace(common_lookup_elements));
        let verify_bitwise_xor_12_handle =
            s.spawn(move || verify_bitwise_xor_12.write_interaction_trace(common_lookup_elements));
        let verify_bitwise_xor_4_handle =
            s.spawn(move || verify_bitwise_xor_4.write_interaction_trace(common_lookup_elements));
        let verify_bitwise_xor_7_handle =
            s.spawn(move || verify_bitwise_xor_7.write_interaction_trace(common_lookup_elements));
        let verify_bitwise_xor_9_handle =
            s.spawn(move || verify_bitwise_xor_9.write_interaction_trace(common_lookup_elements));
        let range_check_15_handle =
            s.spawn(move || range_check_15.write_interaction_trace(common_lookup_elements));
        let range_check_16_handle =
            s.spawn(move || range_check_16.write_interaction_trace(common_lookup_elements));
