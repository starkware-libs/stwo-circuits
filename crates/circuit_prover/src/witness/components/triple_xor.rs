...
fn write_trace_simd(
    ...
    let [triple_xor_input_addr_0, triple_xor_input_addr_1, triple_xor_input_addr_2, triple_xor_output_addr, mults]: [Vec<PackedM31>; 5] =
        preprocessed_columns.try_into().unwrap();

    (trace.par_iter_mut(), lookup_data.par_iter_mut(), sub_component_inputs.par_iter_mut(), inputs.into_par_iter())
        .into_par_iter()
        .enumerate()
        .for_each(|(row_index, (row, lookup_data, sub_component_inputs, triple_xor_input))| {
            ...
            *row[14] = ms_8_bits_col14;
            let split_16_low_part_size_8_output_tmp_b1429_13 =
                [((input_a_xor_b_xor_c_limb_0_col6) - ((ms_8_bits_col14) * (M31_256))), ms_8_bits_col14];
            ...
            *row[15] = ms_8_bits_col15;
            let split_16_low_part_size_8_output_tmp_b1429_15 =
                [((input_a_xor_b_xor_c_limb_1_col7) - ((ms_8_bits_col15) * (M31_256))), ms_8_bits_col15];
            ...
            *row[17] = xor_col17;
            *sub_component_inputs.verify_bitwise_xor_8[1] = [ms_8_bits_col8, ms_8_bits_col10, xor_col17];
            ...
            *row[19] = xor_col19;
            *sub_component_inputs.verify_bitwise_xor_8[3] = [ms_8_bits_col9, ms_8_bits_col11, xor_col19];
            ...
            *lookup_data.gate_3 =
                [M31_378353459, triple_xor_output_addr, input_a_xor_b_xor_c_limb_0_col6, input_a_xor_b_xor_c_limb_1_col7];
        });

    lookup_data.mults_0 = mults;
