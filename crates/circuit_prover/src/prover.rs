...
pub fn add_zk_blinding(context: &mut Context<QM31>, seed_bytes: [u8; 32], n_padding: usize) {
    ...
    for _ in 0..n_padding {
        ...
        let var1 = context.new_var(value1);
        ...
        let var2 = context.new_var(value2);
        context.circuit.add.push(circuits::circuit::Add {
        ...
        let var3 = context.new_var(value3);
        context.circuit.add.push(circuits::circuit::Add {
            in0: var3.idx,
            in1: context.zero().idx,
            out: var3.idx,
