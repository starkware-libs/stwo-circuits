...
pub fn prove_circuit(context: &mut Context<QM31>) -> CircuitProof {
    ...
    prove_circuit_assignment(context.values(), &preprocessed_circuit, &BaseColumnPool::<SimdBackend>::new())
}
...
pub fn prove_circuit_assignment(
    ...
    let mut commitment_scheme =
        CommitmentSchemeProver::<SimdBackend, Blake2sM31MerkleChannel>::with_memory_pool(pcs_config, &twiddles, base_column_pool);
