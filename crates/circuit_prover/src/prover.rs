...
use crate::witness::preprocessed::{PreProcessedTrace, PreprocessedCircuit};
...
pub fn prove_circuit(context: &mut Context<QM31>) -> (CircuitProof, Vec<u32>) {
    ...
    let preprocessed_circuit = PreProcessedTrace::generate_preprocessed_trace(&context.circuit);
