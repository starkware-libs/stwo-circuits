...
impl FrameworkEval for Eval {
    ...
    fn evaluate<E: EvalAtRow>(&self, mut eval: E) -> E {
        ...
        let [split_16_low_part_size_8_output_tmp_b1429_1_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_b1429_3_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_b1429_5_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_b1429_7_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_b1429_9_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_b1429_11_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_b1429_13_limb_0] = Split16LowPartSize8::evaluate(
        ...
        #[allow(clippy::unused_unit)]
        #[allow(unused_variables)]
        let [split_16_low_part_size_8_output_tmp_b1429_15_limb_0] = Split16LowPartSize8::evaluate(
        ...
        BitwiseXorNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_b1429_1_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_b1429_5_limb_0.clone(),
            ],
            xor_col16.clone(),
            &self.common_lookup_elements,
        ...
        BitwiseXorNumBits8::evaluate(
            [
                split_16_low_part_size_8_output_tmp_b1429_3_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_b1429_7_limb_0.clone(),
            ],
            xor_col18.clone(),
            &self.common_lookup_elements,
            E::EF::from(M31_1.clone()),
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                M31_112558620.clone(),
                xor_col16.clone(),
                split_16_low_part_size_8_output_tmp_b1429_9_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_b1429_13_limb_0.clone(),
            ],
        ));
        ...
        eval.add_to_relation(RelationEntry::new(
            ...
            &[
                M31_112558620.clone(),
                xor_col18.clone(),
                split_16_low_part_size_8_output_tmp_b1429_11_limb_0.clone(),
                split_16_low_part_size_8_output_tmp_b1429_15_limb_0.clone(),
            ],
        ));
