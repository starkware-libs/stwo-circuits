...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let seq_16 = acc.get_preprocessed_column(&PreProcessedColumnId { id: "seq_16".to_owned() });

    // Yield RangeCheck_16.
    let tuple_0 = &[eval!(context, 1008385708), eval!(context, seq_16)];
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([(
            ...
            context.constant(qm31_from_u32s(1628242403, 720326688, 1130223559, 1758380471)),
        )]);
        ...
        assert_eq!(result_value, RANGE_CHECK_16_SAMPLE_EVAL_RESULT)
    }
}
