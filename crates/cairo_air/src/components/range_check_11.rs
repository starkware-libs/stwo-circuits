...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([(
            PreProcessedColumnId { id: "seq_11".to_owned() },
            context.constant(qm31_from_u32s(1292696508, 49238048, 794679239, 1758380471)),
        )]);
        ...
        assert_eq!(result_value, RANGE_CHECK_11_SAMPLE_EVAL_RESULT)
    }
}
