    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([
            (
                ...
                context.constant(qm31_from_u32s(1052671046, 1968306984, 497428152, 1503133367)),
            ),
            (
                PreProcessedColumnId { id: "bitwise_xor_9_1".to_owned() },
                context.constant(qm31_from_u32s(985561867, 1834089256, 430319288, 1503133367)),
            ),
            (
                PreProcessedColumnId { id: "bitwise_xor_9_2".to_owned() },
                context.constant(qm31_from_u32s(918452688, 1699871528, 363210424, 1503133367)),
            ),
        ]);
        ...
        assert_eq!(result_value, VERIFY_BITWISE_XOR_9_SAMPLE_EVAL_RESULT)
    }
}
