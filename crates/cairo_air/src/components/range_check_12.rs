...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let seq_12 = acc.get_preprocessed_column(&PreProcessedColumnId { id: "seq_12".to_owned() });

    // Yield RangeCheck_12.
    let tuple_0 = &[eval!(context, 941275232), eval!(context, seq_12)];
...
impl<Value: IValue> CircuitEval<Value> for Component {
    ...
    fn evaluate(
        ...
        // Verify this component has 2 ** 12 rows
        let size_bit = component_data.get_n_instances_bit(context, 12);
...
mod tests {
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([(
            PreProcessedColumnId { id: "seq_12".to_owned() },
            context.constant(qm31_from_u32s(1359805687, 183455776, 861788103, 1758380471)),
        )]);
        ...
        assert_eq!(result_value, RANGE_CHECK_12_SAMPLE_EVAL_RESULT)
    }
}
