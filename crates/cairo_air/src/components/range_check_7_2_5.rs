...
pub fn accumulate_constraints<Value: IValue>(
    ...
    let range_check_7_2_5_column_0 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_7_2_5_column_0".to_owned(),
    });
    let range_check_7_2_5_column_1 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_7_2_5_column_1".to_owned(),
    });
    let range_check_7_2_5_column_2 = acc.get_preprocessed_column(&PreProcessedColumnId {
        id: "range_check_7_2_5_column_2".to_owned(),
    });

    // Yield RangeCheck_7_2_5.
    let tuple_0 = &[
        eval!(context, 371240602),
        eval!(context, range_check_7_2_5_column_0),
        eval!(context, range_check_7_2_5_column_1),
        eval!(context, range_check_7_2_5_column_2),
    ];
    ...
    fn test_evaluation_result() {
        ...
        let preprocessed_columns = HashMap::from([
            (
                ...
                context.constant(qm31_from_u32s(511731811, 1003307901, 686287373, 2115861185)),
            ),
            (
                PreProcessedColumnId { id: "range_check_7_2_5_column_1".to_owned() },
                context.constant(qm31_from_u32s(578840990, 1137525629, 753396237, 2115861185)),
            ),
            (
                PreProcessedColumnId { id: "range_check_7_2_5_column_2".to_owned() },
                context.constant(qm31_from_u32s(377513453, 734872445, 552069645, 2115861185)),
            ),
        ]);
        ...
        assert_eq!(result_value, RANGE_CHECK_7_2_5_SAMPLE_EVAL_RESULT)
    }
}
