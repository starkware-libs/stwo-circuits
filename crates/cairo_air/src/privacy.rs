...
pub const PRIVACY_CAIRO_VERIFIER_CONSTS_HASH: [u32; 8] =
    [565520083, 774808055, 116329413, 854158029, 1790335115, 1117317925, 572870874, 326909848];

pub const PRIVACY_RECURSION_CIRCUIT_CONSTS_HASH: [u32; 8] =
    [1944370684, 902309443, 2081492267, 499975837, 649634589, 867809319, 1037055651, 276544554];
