...
pub const PRIVACY_RECURSION_CIRCUIT_CONSTS_HASH: [u32; 8] = [
    1392983571, 1317154055, 2145331802, 1428305823, 1476228174, 1674342540, 1107952203, 1156204559,
];

pub const PRIVACY_RECURSION_CIRCUIT_PREPROCESSED_ROOT: [u32; 8] =
    [1083101674, 1726140223, 1619794454, 1495677910, 1655947113, 1543793077, 796765314, 1795027865];
